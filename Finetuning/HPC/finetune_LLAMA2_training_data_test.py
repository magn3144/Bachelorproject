...
def reload_model(model_name, dataset, r, epochs, lr, finetune_name):
    ...
    training_arguments = TrainingArguments(
        ...
        report_to="wandb",
        run_name=f"finetuned_{finetune_name}"
    )
...
save_directory = "/work3/s204164/LLAMA2_Finetuning/trained_models/data_test"
...
for data_split in data_splits:
    dataset = load_dataset(dataset_name, split=f"train[0:{data_split}]") #860
    finetune_name = f"finetuned_data_split{data_split}"
