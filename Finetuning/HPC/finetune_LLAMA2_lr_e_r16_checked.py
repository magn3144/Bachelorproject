...
def reload_model(model_name, dataset, r, epochs, lr, finetune_name):
...
save_directory = "/work3/s204164/LLAMA2_Finetuning/trained_models/lr_e_checked"
dataset = load_dataset(dataset_name, split="checked[0:226]")
...
epochs_values = [1, 2, 3, 4, 5, 6, 7, 8]
r = 16
print("r values:", lr_values)
print("epochs range:", epochs_values)
for lr in lr_values:
    for epochs in epochs_values:
        finetune_name = f"finetuned_lr{lr}_e{epochs}_checked"
        ...
        trainer, model = reload_model(model_name, dataset, r, epochs, lr, finetune_name)
        trainer.train()
