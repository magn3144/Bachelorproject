...
The task is: Get the DTU entrepreneourship adress and save it in a csv file in a single row. Remove quotation marks from the address text, and add quotation marks around the whole address.
...
#print(soup.find_all('span')[1].text.strip())

#print(soup.find_all('span')[1].text.strip().replace('\n', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', '').replace('|', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', '').replace('|', '').replace('5', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', '').replace('|', '').replace('5', '').replace('T', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', '').replace('|', '').replace('5', '').replace('T', '').replace('e', ''))

#print(soup.find_all('span')[1].text.strip().replace('\n', '').replace('|', '').replace(' ', '').replace('ECTS', '').replace('5', '').replace('Digital', '').replace('trends', '').replace('for', '').replace('entrepreneurs', '').replace('|', '').replace('5', '').replace('E', '').replace('CTS', '').replace('|', '').replace('5', '').replace('S', '').replace('|', '').replace('5', '').replace('T', '').replace('e', '').replace('n', ''))
