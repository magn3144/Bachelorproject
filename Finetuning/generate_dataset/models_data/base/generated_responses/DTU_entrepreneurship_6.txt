...
The task is: Get all the descriptions in small text under the title of each course.
...
course_titles = soup.find_all('h2', class_='a-heading-h1 o-hero__title')
course_descriptions = soup.find_all('p', class_='a-paragraph-lead o-hero__text')
...
for description in course_descriptions:
    course_descriptions_list.append(description.text)

course_titles_list = course_titles_list[:-1]
course_descriptions_list = course_descriptions_list[:-1]
